...
<div class="modal fade" id="insertCompanyModal">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-footer justify-content-between">
				<button id="resetInsertCompanyModalBtn" type="button" class="btn btn-default">다시 입력</button>
				<button id="insertCompanyBtn" type="button" class="btn btn-primary">등록</button>
			</div>
